...
<html lang="en">
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    <div class="container">
                        ...
                        <p class="h4 d-flex justify-content-center" style="color:aliceblue; margin-top: 20px; ">Use the code blocks to print like this "Your score is: 95".</p>
                    </div>
                ...
                <div class="container1">
                        ...
                        <div class="code-block" data-code="('Your" draggable="true" ondragstart="drag(event)"  style="color:aliceblue; font-family: 'Arial';">('Your</div>
                        <div class="code-block" data-code="score" draggable="true" ondragstart="drag(event)"        style="color:aliceblue; font-family: 'Arial';">score</div >
                        <div class="code-block" data-code="is:" draggable="true" ondragstart="drag(event)"style="color:aliceblue; font-family: 'Arial';">is:</div>
                        <div class="code-block" data-code="{}'" draggable="true" ondragstart="drag(event)"style="color:aliceblue; font-family: 'Arial';">{}'</div>
                        <div class="code-block" data-code=".format(score))" draggable="true" ondragstart="drag(event)"style="color:aliceblue; font-family: 'Arial';">.format(score))</div>
                        <!-- Code-Area -->
                        ...
                        <div class="message" id="message" style="color:aliceblue;">Output: Your score is: 95</div>
                        <br>
                        ...
                        <br>
                        <div class="actual" id="actual"></div>    
                        <a id="nextPageButton" href="#" class="btn btn-primary" style="color:aliceblue; font-family: 'Arial'; display: none; width:80px;">Next Page</a>
    ...
    function checkCode() {
      ...
      const expectedPattern = "print ('Your score is: {}' .format(score))";
