...
<html lang="en">
    ...
    .message, .nextPageButton{ /* Added styles for expected and actual */
      background-color: blueviolet;
      border-radius: 15px;
      margin-top: 10px;
      margin: 20px;
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    <div class="container">
                        ...
                        <p class="h4 d-flex justify-content-center" style="color:aliceblue; margin-top: 20px; ">Use the code blocks to print Hello World.</p>
                    </div>
                ...
                <div class="container1">
                        ...
                        <div class="code-block" data-code="('Hello" draggable="true" ondragstart="drag(event)"  style="color:aliceblue; font-family: 'Arial';">('Hello</div>
                        <div class="code-block" data-code="," draggable="true" ondragstart="drag(event)"        style="color:aliceblue; font-family: 'Arial';">,</div >
                        <div class="code-block" data-code="World!');" draggable="true" ondragstart="drag(event)"style="color:aliceblue; font-family: 'Arial';">World!');</div>
                        ...
                        <div class="message" id="message">Output: Hello World</div>
                        ...
                        <a id="nextPageButton" href="introprob2.php" class="btn btn-primary" style="color:aliceblue; font-family: 'Arial'; display: none; width:80px;">Next Page</a>
    ...
    function checkCode() {
      ...
      const expectedPattern = "print ('Hello , World!');";
    ...
    // Hide the Next Page button if the code is incorrect
